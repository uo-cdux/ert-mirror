...
void rooflineKernel(uint64_t nsize, uint64_t ntrials, double *__restrict__ A, int *bytes_per_elem,
                    int *mem_accesses_per_elem)
{
  *bytes_per_elem        = sizeof(*A);
  *mem_accesses_per_elem = 2;

  hipLaunchKernelGGL((block_stride), dim3(hip_blocks), dim3(hip_threads), 0, 0, ntrials, nsize, A);
}
